...
function getPost(article){
  ...
  // Insert color options
    for (let colors of article.colors){
     ...
     // Insert size options
     for (let size of article.size){
        console.table(size);
        let productsize = document.createElement("option");
        document.querySelector("#size").appendChild(productsize);
...
function addToCart(article)  {
  ...
  //Retrieve the choice of color
    let choixCouleur = colorselection.value;
     ...
     //Retrieve the choice of size
     let choixsize = sizeselection.value;
